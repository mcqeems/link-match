  ...
  return (
    <ObserverProvider>
      <div className="min-h-dvh md:mt-12 mt-4">
        ...
        <section>
          <div className="max-w-7xl mx-auto px-6 pt-14 pb-6 intersect-once intersect:motion-preset-slide-up">
        ...
        <section id="visi-misi" className="pt-2 pb-8 px-6">
          <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6 intersect-once intersect:motion-preset-slide-up">
        ...
        <section className="py-16 px-6">
          <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-8 items-start intersect-once intersect:motion-preset-slide-up">
        ...
        <section className="py-12 px-6">
          <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-6 intersect-once intersect:motion-preset-slide-up">
        ...
        {/* Developer Card */}
        <section className="py-16 px-6">
          <div className="max-w-3xl mx-auto intersect-once intersect:motion-preset-slide-up">
